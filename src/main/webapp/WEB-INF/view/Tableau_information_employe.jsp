...
<body>
    ...
    -->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					<li><a href="/acc/choix"> <i class="pe-7s-add-user"></i>
							<p>Créer des comptes</p>
					</a></li>
					<li class="active"><a href="/emp/Liste_employees"> <i
							class="pe-7s-id"></i>
							<p>Liste des employees</p>
					</a></li>

					<li><a href="/stg/Liste_stagiaires"> <i
											...
											<div class="table-wrapper">
												<div class="table-title">
													<div class="row">
														...
														<div class="col-sm-7">
															<a href="/formulaire_employee" class="btn btn-secondary"><i
																class="material-icons">&#xE147;</i> <span>Ajouter
																	nouveau employé</span></a> <a href="#" class="btn btn-secondary"><i
